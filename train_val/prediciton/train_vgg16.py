...
from deepclothing.model.multiclass_vgg16 import MultiClassNetwork
...
def train(lr=0.005,
    ...
    train_data_tensor = input_data.get_tensor_data("train", batch_size=train_batch_size, is_shuffle=True)
